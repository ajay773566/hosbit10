                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav show">
                                <div class="logo">
                                    ...
                                    <?php if(isset($hosbit_redux_demo['logo_2']['url']) && $hosbit_redux_demo['logo_2']['url'] != ''){ ?>
                                        <img src="<?php echo esc_url($hosbit_redux_demo['logo_2']['url']); ?>" alt="Logo">
                                    <?php }else{ ?>
                                        <img src="<?php echo get_template_directory_uri();?>/img/logo/fw_logo.png" alt="Logo">
                                    <?php } ?>
                                    </a>
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul>
                                        ...
                                        <li class="header-btn"><a href="<?php echo wp_specialchars_decode(esc_attr($hosbit_redux_demo['header_link_button']));?>" class="btn green-btn"><i class="fas fa-unlock-alt"></i> <?php echo wp_specialchars_decode(esc_attr($hosbit_redux_demo['header_button']));?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </nav>
