          ...
          <div class="row">
              <div class="col-12">
                  <div class="breadcrumb-content text-center">
                      <h2><?php printf( esc_html__( 'Search Results for : %s', 'hosbit' ), get_search_query() ); ?>
                      </h2>
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">
                                <?php echo esc_html__( 'Search Result', 'hosbit' );?>
                              </li>
                          </ol>
                      </nav>
                  </div>
          ...
          <div class="col-lg-8">
            ...
            <?php endwhile; else :?>
              <div class="search-custom" >
                ...
                echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'hosbit' ) ;?>
                </h4>
                <?php get_search_form();?>
              </div>
            <?php endif;?> 
