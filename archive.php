          ...
          <div class="row">
              <div class="col-12">
                  <div class="breadcrumb-content text-center">
                      <h2><?php
                          if ( is_day() ) :
                              printf( esc_html__( 'Daily Archives : %s', 'hosbit' ), get_the_date() );
                          elseif ( is_month() ) :
                              printf( esc_html__( 'Monthly Archives: %s', 'hosbit' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'hosbit' ) ) );
                          elseif ( is_year() ) :
                              printf( esc_html__( 'Yearly Archives: %s', 'hosbit' ), get_the_date( _x( 'Y', 'yearly archives date format', 'hosbit' ) ) );
                          else :
                              echo esc_html__( 'Archives', 'hosbit' );
                          endif;
                        ?>
                      </h2>
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">
                                <?php echo esc_html__( 'Archives', 'hosbit' );?>
                              </li>
                          </ol>
                      </nav>
                  </div>
