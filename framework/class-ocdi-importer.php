	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Hosbit Home 1', 'agroly' ),
				'page'  => __( 'Home One', 'agroly' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home1.png',
				'preview_link' => 'https://shtheme.org/demosd/hosbit/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Hosbit Home 2', 'agroly' ),
				'page'  => __( 'Home Two', 'agroly' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home2.png',
				'preview_link' => 'https://shtheme.org/demosd/hosbit/?page_id=39',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'agroly' ),
			);
		}
