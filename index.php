          ...
          <div class="row">
              <div class="col-12">
                  <div class="breadcrumb-content text-center">
                      <h2><?php if(isset($hosbit_redux_demo['blog_title'])){?>
                          <?php echo wp_specialchars_decode(esc_attr($hosbit_redux_demo['blog_title']));?>
                          <?php }else{?>
                          <?php echo esc_html__( 'Our Blog', 'hosbit' );}?>
                      </h2>
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">
                                <?php if(isset($hosbit_redux_demo['blog_title'])){?>
                                <?php echo wp_specialchars_decode(esc_attr($hosbit_redux_demo['blog_title']));?>
                                <?php }else{?>
                                <?php echo esc_html__( 'Our Blog', 'hosbit' );}?>
                              </li>
